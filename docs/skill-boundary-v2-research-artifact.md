...
| `reports/skill-boundary-v2-experiment.md` | Human-readable result report generated by the runner. |
| `reports/skill-boundary-v2-experiment.json` | Machine-readable result packet generated by the runner. |
